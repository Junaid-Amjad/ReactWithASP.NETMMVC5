...
export default observer(function SearchForm() {
  ...
  const {
    getSearchFilterFiles,
    savedFileSearchedRegistry,
    loadingSearchingFile,
    isLoadingContent,
  } = searchFileStore;
  ...
  async function handleFormSubmit(searchformparameter: SearchForminterface) {
    ...
    var timefrom =
      (searchformparameter.TimeFrom!.getHours() < 10 ? "0" : "") +
      searchformparameter.TimeFrom!.getHours() +
      ":" +
      (searchformparameter.TimeFrom!.getMinutes() < 10 ? "0" : "") +
      searchformparameter.TimeFrom!.getMinutes() +
      ":" +
      (searchformparameter.TimeFrom!.getSeconds() < 10 ? "0" : "") +
      searchformparameter.TimeFrom!.getSeconds();

    var timeto =
      (searchformparameter.TimeTo!.getHours() < 10 ? "0" : "") +
      searchformparameter.TimeTo!.getHours() +
      ":" +
      (searchformparameter.TimeTo!.getMinutes() < 10 ? "0" : "") +
      searchformparameter.TimeTo!.getMinutes() +
      ":" +
      (searchformparameter.TimeTo!.getSeconds() < 10 ? "0" : "") +
      searchformparameter.TimeTo!.getSeconds();

    var datefrom = new Date(
      searchformparameter.DateFrom?.toDateString() + " " + timefrom.toString()
    );
    var dateto = new Date(
      searchformparameter.DateTo?.toDateString() + " " + timeto.toString()
    );
  ...
  return (
    <>
      <Segment clearing>
        <Grid columns={2}>
          <Grid.Column>
            <Header as="h2" content="Searching and Display Options" />
          </Grid.Column>
